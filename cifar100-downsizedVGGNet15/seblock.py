...
def SE_block(x,ratio):
    ...
    with tf.variable_scope("se_fc1"):
        ...
        b_excitation1 = tf.get_variable('biase', shape=[int(channel_out/ratio)], initializer=tf.constant_initializer(0.0))
    ...
    with tf.variable_scope("se_fc2"):
        ...
        b_excitation2 = tf.get_variable('biase', shape=[channel_out], initializer=tf.constant_initializer(0.0))
