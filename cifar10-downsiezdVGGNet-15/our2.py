...
def forward_propagation(input_tensor, input_images, seed):
    ...
    decoder_fcn_w1 = y9_hat[seed, 0: 10240]
    decoder_fcn_w1 = tf.reshape(decoder_fcn_w1, [1024, 10])
    decoder_fcn_b1 = y9_hat[seed, 10240: 10250]
    ...
    logits = tf.matmul(p, decoder_fcn_w1) + decoder_fcn_b1
...
def main(epoch_nums):
    ...
    with open('dataset/result1/test_acc', 'wb') as f:
