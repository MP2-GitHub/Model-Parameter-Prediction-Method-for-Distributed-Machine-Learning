...
tf.app.flags.DEFINE_integer('worker_batch_size', 1000, """The number of sample for each worker to train.""")
...
tf.app.flags.DEFINE_integer('len', 47831524, """Size of initial parameters byte.""")
