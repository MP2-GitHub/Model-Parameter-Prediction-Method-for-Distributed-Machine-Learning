...
class Cifar10:
    class test:
        pass # 在python中有时候能看到定义一个def函数，函数内容部分填写为pass。这里的pass主要作用就是占据位置，让代码整体完整。如果定义一个函数里面为空，那么就会报错，当你还没想清楚函数内部内容，就可以用pass来进行填坑。
    ...
    def _load_data(self):
        ...
        dic["train_images"] = images[10000:].transpose(0, 2, 3, 1) # 旋转，通道数换到第四维
